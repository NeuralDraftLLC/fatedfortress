-- 007 — Marketplace filters + RLS + context card metadata
--
...
-- Already added in 005, but we add a comment to clarify marketplace intent:
...
-- The accepted_roles text[] (added in 004) enables skill-based filtering in the marketplace.
-- No additional index needed — GIN index already created in 004.

-- Context card columns (deliverable_type, context_snippet, inferred_brief) added in 001.
